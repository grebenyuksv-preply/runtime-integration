...
```javascript
var alpha_dd7875624ee24632b385 =
```
...
```javascript
{"name":"alpha_dd7875624ee24632b385","content":{"./alpha.js":{"id":1,"buildMeta":{"providedExports":true}},"./a.js":{"id":2,"buildMeta":{"providedExports":true}},"../node_modules/module.js":{"id":3,"buildMeta":{"providedExports":true}}}}
```
...
MyDll.alpha.js  4.42 KiB       0  [emitted]  alpha
 MyDll.beta.js  85.3 KiB       1  [emitted]  beta
...
chunk    {0} MyDll.alpha.js (alpha) 84 bytes [entry] [rendered]
 ...
 [2] ./a.js 21 bytes {0} [built]
     single entry ./a [0] dll alpha alpha[1]
      DllPlugin
     + 1 hidden module
chunk    {1} MyDll.beta.js (beta) 79.5 KiB [entry] [rendered]
    > beta
  ...
  [5] ./beta.js 24 bytes {1} [built]
      single entry ./beta [4] dll beta beta[0]
       DllPlugin
  [6] ./b.js 127 bytes {1} [built]
      single entry ./b [4] dll beta beta[1]
       DllPlugin
 [12] ./c.jsx 23 bytes {1} [built]
...
MyDll.alpha.js  1.06 KiB       0  [emitted]  alpha
 MyDll.beta.js  8.69 KiB       1  [emitted]  beta
Entrypoint alpha = MyDll.alpha.js
Entrypoint beta = MyDll.beta.js
chunk    {0} MyDll.alpha.js (alpha) 84 bytes [entry] [rendered]
    > alpha
 ...
 [2] ./a.js 21 bytes {0} [built]
     single entry ./a [0] dll alpha alpha[1]
      DllPlugin
     + 1 hidden module
chunk    {1} MyDll.beta.js (beta) 9.09 KiB [entry] [rendered]
    > beta
  [4] dll beta 12 bytes {1} [built]
      dll entry 
       DllPlugin
